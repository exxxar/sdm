<template>
    <div>
        <layout title="Добавить устройство" :info="false">
                ...
                <div class="row w-100 m-auto justify-content-end align-items-center">
                    ...
                    <div class="col-md-3">
                        ...
                        >
                            ...
                            <p style="color: #9d9ea5" class="switch-label">Группы устройств</p>
                        </div>
                    </div>
                    <div class="col-md-3">
...
export default {
    name: "DevicesPage",
    props: ['user', 'device_groups', 'boundaries', 'device_types', 'regions'],
    components: {
        Layout, DevicesAdd
    },
    data: () => ({
