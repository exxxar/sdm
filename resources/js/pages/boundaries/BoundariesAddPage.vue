<template>
    <div>
        <layout title="Добавить рубеж" :info="false">
...
import BoundariesAdd from "../../components/boundaries/BoundariesAdd";

export default {
    name: "BoundariesAddPage",
    props: ['user', 'boundary_groups', 'regions', 'devices', 'violations'],
    components: {
        Layout, BoundariesAdd
    },
    data: () => ({
        format_table: true,
        groups: false,
