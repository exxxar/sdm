<template>
    <layout :title="dictionary_type_title" :info="false">
            ...
            <div class="row w-100 m-auto justify-content-end align-items-center">
                <div style="z-index: 9" class="col-12 col-md-9">
                    ...
                    >
                        ...
                        <li class="" aria-current="page" >
                            <a href="#" style="border-bottom: 3px solid #7224f2; color: black; text-decoration: none; font-weight: 500; padding: 15px 0px">
        ...
        <template v-slot:main>
            <dictionaries-add :dictionary_type_id="dictionary_type_id"></dictionaries-add>
        </template>
    </layout>
</template>
...
<script>
    ...
    import DictionariesAdd from "../../components/dictionaries/DictionariesAdd";
    export default {
        name: "DictionariesAddPage",
        props:['user', 'dictionary_type_title','dictionary_type_id'],
        components:{Layout, DictionariesAdd}
    }
</script>
