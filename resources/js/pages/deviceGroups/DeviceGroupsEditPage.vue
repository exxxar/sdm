            ...
            <template v-slot:menu>
                <div class="row w-100 m-auto justify-content-end align-items-center">
                    ...
                    <div class="col-md-3">
                        ...
                        >
                            <p style="color:#9d9ea5" class="switch-label">Все устройства</p>
...
import DeviceGroupsEdit from "../../components/deviceGroups/DeviceGroupsEdit";

export default {
    name: "DeviceGroupsAddPage",
    props: ['user', 'devices', 'group', 'connecteddevices'],
    components: {
        Layout, DeviceGroupsEdit
    },
    data: () => ({
        groups: true,
    }),
