<template>
    <div>
        <layout title="Группы устройств" :info="true" :info_text="'Это группы устройств.'">
            ...
            <template v-slot:header>
                ...
                <div class="row w-100 m-auto justify-content-end align-items-center pb-2 mb-3">
                    ...
                    <div class="col-12 col-md-2 p-0 justify-content-center">
                    ...
                    <div class="col-12 col-md-2 col-sm-6 px-0">
                        ...
                        >Загрузка из файла</label>
                        <a class="sub-text" target="_blank" href="/templates/device_groups">Скачать шаблон</a>
                    </div>
                </div>
            </template>
...
import DeviceGroups from "../../components/deviceGroups/DeviceGroups";

export default {
    name: "DeviceGroupsPage",
    props: ["user"],
    components: {
        Layout,
        DeviceGroups
    ...
    methods: {
        ...
        addGroup: function() {
            window.location.href = "/device-groups/add";
        },
