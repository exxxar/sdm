<template>
    <div>
        <layout :title="'Редактировать обращение №'+appeal.id" :info="false">
...
import AppealsEdit from "../../components/appeals/AppealsEdit";

export default {
    name: "AppealsAddPage",
    props: ['user', 'users', 'boundaries', 'devices', 'malfunctions', 'appeal'],
    components: {
        Layout, AppealsEdit
    },
    data: () => ({
