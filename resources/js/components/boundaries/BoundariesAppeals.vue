<template>
    <div>
        ...
        <div class="row w-100 mx-auto mt-3 align-items-center justify-content-center" v-if="format_table===true">
            <div v-if="item.boundary_id === boundary.id && (actual && item.status === 'Актуальные' || inWork && item.status === 'В работе' || ready && item.status === 'Готово')" class="col-12 p-0" v-for="item in data">
                <div class="row w-100 mx-auto mb-1 py-3 px-3 px-sm-0 align-items-center justify-content-center"  style="background: #FFFFFF; border-radius: 5px; max-width: 1420px; ">
                    <div class="col-12 col-md-4 col-sm-12">
                        <div class="row w-100 my-1 align-items-center justify-content-start">
                            ...
                            <div class="col-10">
                                <h6 class="ml-1 mb-0" style="font-size: 12px;font-weight: 300">{{item.boundary.title}}</h6>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-sm-12 col-md-2">
                        <div style="flex-wrap: nowrap" class="row w-100 mx-auto my-1 align-items-center justify-content-end">
                            <button class="btn mr-6 mt-1 border-copy-button" v-if="item.status === 'Готово'">
        ...
        <div v-if="format_table!==true" class="row w-100 m-auto row-cols-1 row-cols-md-2 row-cols-lg-3 g-4 align-items-start">
            <div v-if="item.boundary_id === boundary.id && (actual && item.status === 'Актуальные' || inWork && item.status === 'В работе' || ready && item.status === 'Готово')" class="col-12 col-lg-3 col-md-6 px-2" v-for="item in data">
                        ...
                        ">
                            ...
                            <div  class="col-4 p-0" v-if="item.status === 'Готово'">
                                <div class="row w-100 m-auto justify-content-end">
                                    <button class="btn p-0 border-copy-button">
                                        <span style="font-size: 10px; border-bottom: 1px solid #9b65f2">Отчет</span>
                                    </button>
        ...
        methods: {
            ...
            deleteItem(id) {
                ...
                axios
                    ...
                    .then((resp) => {
                        console.log(resp);
                        this.sendNotify('Вы успешно удалили обращение рубежа', 'success');
