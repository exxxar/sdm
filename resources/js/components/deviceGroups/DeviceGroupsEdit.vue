...
export default {
    name: "AppealsAdd",
    props: ['devices', 'group', 'connecteddevices'],
    created() {
        this.selected = this.connecteddevices;
    ...
    computed: {
        allDeviceFilter: function () {
            ...
            return this.all_device_filter === '' ? this.not_selected :
                this.not_selected
        ...
        selectedDeviceFilter: function () {
            ...
            return this.selected_device_filter === '' ? this.selected :
                this.selected
    ...
    methods: {
        ...
        submit() {
            this.loading = true
            this.edited_group.devices = this.selected;
            axios
                .patch(`/device-group/${this.group.id}`, this.edited_group)
                .then(() => {
